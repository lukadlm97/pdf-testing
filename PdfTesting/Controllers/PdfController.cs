...
namespace PdfTesting.Controllers
{
    public class PdfController : Controller
    {
        ...
        public IActionResult LayoutCenter()
        {
            PdfDocument document = new PdfDocument();
            PdfPage strana = document.AddPage();
            ...
            zaglavlje.DodajZaglavlje(k, strana);
        ...
        public IActionResult SimpleTitle()
        {
            PdfDocument document = new PdfDocument();
            PdfPage strana = document.AddPage();
            ...
            naslov.PostaviVelikNaslov("Naslov predloga",strana);
        ...
        public IActionResult DocsWithCompsToDesccription()
        {
            PdfDocument document = new PdfDocument();
            PdfPage strana = document.AddPage();
        ...
        public IActionResult DocsWithCompanyInfo()
        {
            PdfDocument document = new PdfDocument();
            PdfPage strana = document.AddPage();
            ...
            informacijeOKompaniji.PostaviInformacije(komp, strana);
        ...
        public IActionResult GeneratePdfDocs()
        {
            ...
            postavljacDatuma.PostaviEvropskiDatum(predlogZaSaradnju.datumPredlaganja,strana);
        ...
        public IActionResult DocsWithSignatureTitle()
        {
            ...
            KomponentaPredlagaca komponentaPredlagaca = new KomponentaPredlagaca();
            komponentaPredlagaca.DodajPozicijuPredlagaca(new Predlagac()
            {
                Ime = "Luka",
                Prezime = "Radovanovic",
                Titula = "student"
        ...
        public IActionResult DocsWithSignature()
        {
            PdfDocument document = new PdfDocument();
            PdfPage strana = document.AddPage();
            ...
            KomponentaPredlagaca komponentaPredlagaca = new KomponentaPredlagaca();
            komponentaPredlagaca.DodajPredlagaca(new Predlagac()
            {
                Ime = "Luka",
                Prezime = "Radovanovic",
                Titula = "student"
